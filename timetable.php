    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse move-me">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="timetable.php">GENERATE TIMETABLE</a></li>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="AssignSubstitute">
            ...
            <div style="display:block" id="assignSubstitueForm">
                <form method="post" action="assignsubstitute.php">
            ...
            var createSubstituteHandler =
                function (cell, i) {
                    return function () {
                        ...
                        xmlhttp.open("GET", "cellindex.php?i=" + i, false);
                        xmlhttp.send();
                    };
                };
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        ...
                        $r = mysqli_fetch_assoc(mysqli_query(mysqli_connect("localhost", "ananya", "ananya1234", "timetable"), "SELECT * from teachers
                        WHERE faculty_id = '$id'"));
                        echo $r['faculty_name'];
